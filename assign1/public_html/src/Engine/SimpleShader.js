...
function SimpleShader(vertexShaderPath, fragmentShaderPath,judge) {
    // instance variables
    ...
    if(judge === true)
        ...
        gl.bindBuffer(gl.ARRAY_BUFFER, gEngine.VertexBuffer.getGLVertexTri());
    ...
    this.mdx = gl.getUniformLocation(this.mCompiledShader,"dx");  ///
    this.mdy = gl.getUniformLocation(this.mCompiledShader,"dy");  ///
...
SimpleShader.prototype.activateShader = function (pixelColor,dx,dy) {
    var gl = gEngine.Core.getGL();
    gl.useProgram(this.mCompiledShader);
    gl.enableVertexAttribArray(this.mShaderVertexPositionAttribute);
    gl.uniform4fv(this.mPixelColor, pixelColor);
    
    gl.uniform1f(this.mdx,dx);  ///
    gl.uniform1f(this.mdy,dy);  ///
